...
const Invoice = () => {
  ...
  const previousMonthFormatted = previousMonthDate.toLocaleDateString(
    "en-US",
    option
  );
            ...
            <ReactToPrint
              trigger={() => (
                <Button sx={{ mr: 2 }}>
                  ...
                  <span style={{ marginLeft: "7px" }}> Generate Bill</span>
                </Button>
              )}
          ...
          <Box sx={{ p: 1, m: 1 }}>
              ...
              <Grid item xs={9} sx={{ height: "10rem" }}>
                <Box>
                  ...
                  <Typography
                    ...
                    ml={-20}
                  >
                    Adam Jee Road Saddar, Rawalpindi
                  </Typography>
                  <Typography
                    textAlign="center"
                    variant="h4"
            ...
            <Stack direction="row" gap={4}>
              <Box
                sx={{
                  width: "48%",
                  backgroundColor: "rgba(164, 189, 255, 0.2)",
                  px: 4,
                  py: 2,
                  borderRadius: "10px",
                }}
              >
                <Typography
                  variant="h6"
                  fontWeight={600}
                  sx={{ width: "100%", color: "#733dd9", display: "block" }}
                >
                  Detail
                </Typography>
                <Box display="flex">
            ...
            <Stack direction="row" gap={4} marginTop={5}>
              <Box width="50%" mt={11} display="flex">
                ...
                <Box
                  sx={{ borderTop: "2px solid black", width: "200px", mt: 4 }}
                >
                  {" "}
                </Box>
              </Box>
              ...
              >
                <Typography variant="h6" color="#733dd9" fontWeight={600}>
                  Maintenance Charges
                </Typography>
                <Box display="flex">
                  <Box width="60%">
                  ...
                  <Box>
                    <Typography variant="body1" color="initial" mt={1}>
                      {shop.shop.shop_remaining_rent}
                    </Typography>
                    <Typography variant="body1" color="initial" mb={1}>
                      {shop.shop.Monthly_rent}
                    </Typography>
                    <Divider variant="fullWidth" orientation="horizontal" />
                    <Typography variant="h5" color="#733dd9" fontWeight={600}>
                      {Number(shop.shop.Monthly_rent) +
                        Number(shop.shop.shop_remaining_rent)}
                    </Typography>
                  </Box>
                </Box>
              </Box>
              ...
              <Grid item xs={12} spacing={4}>
                <Box>
                  <Typography variant="body1" color="initial" textAlign="right">
                    تمام معزز صاحبان کو مطلع کیا جاتا ہے کہمینٹیننس بل کو رابی
                    افس میں مقررہ تاریخ سے قبل ادا کرنا ضروری ہے۔ بصورت دیگر بل
                    تاخیر سے جمع کروانے پر جرمانہ عائد کیا جائے گا، لہذا کسی بھی
                    قسم کی پر یشانی سے بچنے کیلئے اپنے واجبات وقت پر ادا کریں۔
                  </Typography>
                  <Typography variant="body1" color="initial" textAlign="right">
                    واضح رہے کہ مینٹیننس چارجز میں بجلی کے کسی بھی قسم کے چارجز
                    شامل نہیں ہیں۔
                  </Typography>
                </Box>
              </Grid>
            ...
            <Box sx={{ p: 1, ml: 30, width: "90vw" }}>
              ...
              <Stack direction="row" gap={4}>
                ...
                >
                  ...
                  <Box display="flex">
                    <Box
                      sx={{ display: "inline-block", width: "130px", mt: 2 }}
                    >
                      <Typography variant="body1" color="#000" sx={{ mb: 1 }}>
                        Invoice#{" "}
                      </Typography>
              ...
              <Box sx={{ my: 2, display: "flex", gap: 6 }}>
                <Grid item xs={12} spacing={4}>
                  ...
                  >
                    ...
                    >
                      <tr
                        style={{ backgroundColor: "#733dd9", height: "40px" }}
                      >
                        <td style={{ width: "60%" }}>
                          {" "}
                          <Typography
              ...
              <Box sx={{ my: 2, display: "flex", gap: 6 }}>
                <Grid item xs={12} spacing={4}>
                  <Box>
                    ...
                    >
                      تمام معزز صاحبان کو مطلع کیا جاتا ہے کہمینٹیننس بل کو رابی
                      افس میں مقررہ تاریخ سے قبل ادا کرنا ضروری ہے۔ بصورت دیگر
                      بل تاخیر سے جمع کروانے پر جرمانہ عائد کیا جائے گا، لہذا
                      کسی بھی قسم کی پر یشانی سے بچنے کیلئے اپنے واجبات
                      وقت پر ادا کریں۔
                    </Typography>
                    <Typography
                      variant="body1"
                      ...
                      textAlign="right"
                    >
                      واضح رہے کہ مینٹیننس چارجز میں بجلی کے کسی بھی قسم کے
                      چارجز شامل نہیں ہیں۔
                    </Typography>
                  </Box>
                </Grid>
